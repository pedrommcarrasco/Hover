...
class HoverItemView: UIStackView {
    ...
    init(with item: HoverItem, configuration: HoverItemConfiguration) {
        ...
        self.button = HoverButton(tintColor: item.tintColor, backgroundColor: item.backgroundColor, image: item.image, imageSizeRatio: configuration.imageSizeRatio)
        ...
        self.label.textColor = configuration.color
