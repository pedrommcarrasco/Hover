...
public class HoverView: UIView {
    ...
    private enum Constant {
        ...
        static let disabledTransform = CGAffineTransform(scaleX: 0.7, y: 0.7)
    }
    ...
    public init(with configuration: HoverConfiguration = HoverConfiguration(), items: [HoverItem] = []) {
        ...
        self.button = HoverButton(tintColor: configuration.tintColor, backgroundColor: configuration.backgroundColor, image: configuration.image, imageSizeRatio: configuration.imageSizeRatio)
